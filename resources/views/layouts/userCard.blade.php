...
<div class="profile-header" style="display: inline-flex;">
  <div style="position: relative;">
    ...
    @endif
    @endauth
  <div class="profile-avatar" style="width: 60px;height:60px;background-image: url('@if(Auth::user()->avatar == "avatar.png") {{ url("/imgs/".Auth::user()->avatar) }} @else {{ url("/storage/avatar/".Auth::user()->avatar) }} @endif');">
  </div>
  </div>
